...
const ANNOUNCEMENT_TIP_URL: &str =
    "https://raw.githubusercontent.com/gradence/wecode/main/announcement_tip.toml";

const IS_MACOS: bool = cfg!(target_os = "macos");

const PAID_TOOLTIP: &str = "*New* Try the **wecode App** with 2x rate limits until *April 2nd*. Run 'wecode app' or visit https://chatgpt.com/wecode?app-landing-page=true";
const PAID_TOOLTIP_NON_MAC: &str = "*New* 2x rate limits until *April 2nd*.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **wecode App**. Run 'wecode app' or visit https://chatgpt.com/wecode?app-landing-page=true";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with wecode.";
const FREE_GO_TOOLTIP: &str =
    "*New* wecode is included in your plan for free through *March 2nd* – let’s build together.";
...
lazy_static! {
    static ref TOOLTIPS: Vec<&'static str> = RAW_TOOLTIPS
        ...
        .filter(|line| {
            ...
            if !IS_MACOS && line.contains("wecode app") {
                return false;
            }
            true
        })
...
/// Pick a random tooltip to show to the user when starting wecode.
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for wecode TUI.
...
[[announcements]]
content = "Welcome to wecode! Check out the new onboarding flow."
