                        ...
                        Ok(()) => {
                                ...
                                self.chat_widget.world_writable_warning_details()
                            {
                                ...
                                self.chat_widget.add_plain_history_lines(vec![
                                    ...
                                    Line::from(vec![
                                        "  ".into(),
                                        "wecode can now safely edit files and execute commands in your computer"
                                            .dark_gray(),
                                    ]),
                                ]);
                            }
    ...
    async fn handle_thread_created(&mut self, thread_id: ThreadId) -> Result<()> {
        ...
        tokio::spawn(async move {
            loop {
                ...
                if !should_send && matches!(event.msg, EventMsg::AgentWorkSummary(_)) {
        ...
        let editor_cmd = match external_editor::resolve_editor_command() {
            ...
            Err(external_editor::EditorError::MissingEditor) => {
                self.chat_widget
                    ...
                    "Cannot open external editor: set $VISUAL or $EDITOR before starting wecode."
                        .to_string(),
                ));
...
mod tests {
    ...
    async fn session_summary_prefers_name_over_id() {
        ...
        assert_eq!(
            summary.resume_command,
            Some("wecode resume my-session".to_string())
        );
    }
}
