...
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/wecode.json";
const LATEST_RELEASE_URL: &str = "https://api.github.com/repos/gradence/wecode/releases/latest";
...
mod tests {
    ...
    fn extract_version_from_brew_api_json() {
        //
        // https://formulae.brew.sh/api/cask/wecode.json
        let cask_json = r#"{
            "token": "wecode",
            "full_token": "wecode",
            "tap": "homebrew/cask",
