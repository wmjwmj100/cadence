...
pub(crate) fn migration_copy_for_models(
    ...
    let heading_text = Span::from(format!(
        "wecode just got an upgrade. Introducing {target_display_name}."
    ))
    .bold();
...
impl ModelMigrationScreen {
    ...
    fn render_menu(&self, column: &mut ColumnRenderable) {
        column.push(Line::from(""));
        column.push(
            Paragraph::new("Choose how you'd like wecode to proceed.")
                .wrap(Wrap { trim: false })
                .inset(Insets::tlbr(0, 2, 0, 0)),
        );
        column.push(Line::from(""));
    ...
    fn prompt_snapshot() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                ...
                Some("wecode-optimized flagship for deep and fast reasoning.".to_string()),
                true,
            ),
        );
    ...
    fn prompt_snapshot_gpt5_family() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5",
                "gpt-5.1",
                Some("https://www.wecode.com/models/gpt-5.1".to_string()),
                None,
                None,
                "gpt-5.1".to_string(),
    ...
    fn prompt_snapshot_gpt5_codex() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-codex",
                "gpt-5.1-codex-max",
                Some("https://www.wecode.com/models/gpt-5.1-codex-max".to_string()),
                None,
                None,
                "gpt-5.1-codex-max".to_string(),
                Some("wecode-optimized flagship for deep and fast reasoning.".to_string()),
    ...
    fn prompt_snapshot_gpt5_codex_mini() {
        ...
        let screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-5-codex-mini",
                "gpt-5.1-codex-mini",
                Some("https://www.wecode.com/models/gpt-5.1-codex-mini".to_string()),
                None,
                None,
                "gpt-5.1-codex-mini".to_string(),
                Some("Optimized for wecode. Cheaper, faster, but less capable.".to_string()),
                false,
            ),
        );
        {
    ...
    fn escape_key_accepts_prompt() {
        let mut screen = ModelMigrationScreen::new(
            ...
            migration_copy_for_models(
                "gpt-old",
                "gpt-new",
                Some("https://www.wecode.com/models/gpt-new".to_string()),
                None,
                None,
                "gpt-new".to_string(),
