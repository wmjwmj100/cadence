...
impl McpProcess {
    ...
    pub async fn new_with_env(
        ...
        let program = codex_utils_cargo_bin::cargo_bin("wecode-app-server")
            .context("should find binary for wecode-app-server")?;
...
impl Drop for McpProcess {
    fn drop(&mut self) {
        // These tests spawn a `wecode-app-server` child process.
        //
