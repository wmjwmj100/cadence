    ...
    match feature {
        ...
        _ => {
            ...
            let details = if alias == canonical {
                ...
                Some(format!(
                    "Enable it with `--enable {canonical}` or `[features].{canonical}` in config.toml. See https://github.com/gradence/wecode/blob/main/docs/config.md#feature-flags for details."
                ))
            };
            (summary, details)
        }
...
pub const FEATURES: &[FeatureSpec] = &[
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            ...
            announcement: "NEW: Linux bubblewrap sandbox offers stronger filesystem and network controls than Landlock alone, including keeping .git and .codex read-only inside writable workspaces. Enable it in /experimental and restart wecode to try it.",
        },
    ...
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Sub-agents",
            menu_description: "Ask wecode to spawn multiple agents to parallelize the work and win in efficiency.",
            announcement: "NEW: Sub-agents can now be spawned by wecode. Enable in /experimental and restart wecode!",
        },
        default_enabled: false,
    },
    FeatureSpec {
        ...
        stage: Stage::Experimental {
            name: "Apps",
            menu_description: "Use a connected ChatGPT App using \"$\". Install Apps via /apps command. Restart wecode after enabling.",
            announcement: "NEW: Use ChatGPT Apps (Connectors) in wecode via $ mentions. Enable in /experimental and restart wecode!",
        },
        default_enabled: false,
    },
    FeatureSpec {
    ...
    FeatureSpec {
        ...
        stage: if cfg!(target_os = "macos") {
            Stage::Experimental {
                ...
                menu_description: "Keep your computer awake while wecode is running a thread.",
