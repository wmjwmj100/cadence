...
pub(crate) static PRESETS: Lazy<Vec<ModelPreset>> = Lazy::new(|| {
    vec![
        ...
        ModelPreset {
            ...
            description: "wecode-optimized flagship for deep and fast reasoning.".to_string(),
            default_reasoning_effort: ReasoningEffort::Medium,
            supported_reasoning_efforts: vec![
                ReasoningEffortPreset {
                    effort: ReasoningEffort::Low,
        ...
        ModelPreset {
            ...
            description: "Optimized for wecode. Cheaper, faster, but less capable.".to_string(),
            default_reasoning_effort: ReasoningEffort::Medium,
            supported_reasoning_efforts: vec![
                ReasoningEffortPreset {
                    effort: ReasoningEffort::Medium,
        ...
        ModelPreset {
            ...
            description: "Optimized for wecode.".to_string(),
            default_reasoning_effort: ReasoningEffort::Medium,
            supported_reasoning_efforts: vec![
                ReasoningEffortPreset {
                    effort: ReasoningEffort::Low,
...
fn gpt_52_codex_upgrade() -> ModelUpgrade {
    ModelUpgrade {
        ...
        model_link: Some("https://www.wecode.com/models/gpt-5.2-codex".to_string()),
        upgrade_copy: Some(
            "wecode is now powered by gpt-5.2-codex, our latest frontier agentic coding model. It is smarter and faster than its predecessors and capable of long-running project-scale work."
                .to_string(),
        ),
        migration_markdown: Some(
            indoc! {r#"
                **wecode just got an upgrade. Introducing {model_to}.**

                wecode is now powered by gpt-5.2-codex, our latest frontier agentic coding model. It is smarter and faster than its predecessors and capable of long-running project-scale work. Learn more about {model_to} at https://www.wecode.com/models/gpt-5.2-codex
