...
pub use http_gateway::DockerGatewayBackend;
pub use http_gateway::DockerGatewayConfig;
pub use http_gateway::GatewayBackend;
pub use http_gateway::GatewayBackendError;
pub use http_gateway::GatewayHttpServer;
pub use http_gateway::InMemoryGatewayBackend;
...
pub(crate) const TOOL_SUMMARY_ARGUMENT: &str = "summary";
pub(crate) const TOOL_SUMMARY_MAX_CHARS: usize = 120;
pub(crate) const TOOL_SUMMARY_ARGUMENT_DESCRIPTION: &str =
    "Required short summary of the work this agent is currently doing.";
