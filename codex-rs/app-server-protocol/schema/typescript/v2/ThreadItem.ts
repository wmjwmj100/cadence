...
import type { DebugTraceSnapshot } from "./DebugTraceSnapshot";
 ...
 */
agentsStates: { [key in string]?: CollabAgentState }, } | { "type": "debugTraceSnapshot", id: string, trace: DebugTraceSnapshot, } | { "type": "webSearch", id: string, query: string, action: WebSearchAction | null, } | { "type": "imageView", id: string, path: string, } | { "type": "enteredReviewMode", id: string, review: string, } | { "type": "exitedReviewMode", id: string, review: string, } | { "type": "contextCompaction", id: string, };
