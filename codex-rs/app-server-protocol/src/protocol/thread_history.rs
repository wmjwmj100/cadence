...
use codex_protocol::items::summarize_agent_message;
...
impl ThreadHistoryBuilder {
        ...
        match event {
            ...
            EventMsg::AgentMessage(payload) => self.handle_agent_message(
                ...
                if payload.summary.is_empty() {
                    summarize_agent_message(&payload.message)
                } else {
    ...
    fn handle_agent_message(&mut self, text: String, summary: String) {
        if text.is_empty() {
            return;
        }
        ...
        self.ensure_turn()
            .items
            .push(ThreadItem::AgentMessage { id, text, summary });
    }
    ...
    fn handle_collab_waiting_end(
        ...
        let status = if payload.timed_out
    ...
    fn marks_turn_as_interrupted_when_aborted() {
        let events = vec![
            ...
            EventMsg::AgentMessage(AgentMessageEvent {
                ...
                summary: "Second attempt complete.".into(),
            }),
        ];
