...
/// Authentication mode for Gradence-backed providers.
#[derive(Serialize, Deserialize, Debug, Clone, Copy, PartialEq, Eq, Display, JsonSchema, TS)]
#[serde(rename_all = "lowercase")]
pub enum AuthMode {
    /// Gradence API key provided by the caller and stored by wecode.
    ApiKey,
    /// ChatGPT OAuth managed by wecode (tokens persisted and refreshed by wecode).
    Chatgpt,
    /// [UNSTABLE] FOR GRADENCE INTERNAL USE ONLY - DO NOT USE.
    ///
...
client_request_definitions! {
    ...
    /// List recorded wecode conversations (rollouts) with optional pagination and search.
    ListConversations {
        params: v1::ListConversationsParams,
        response: v1::ListConversationsResponse,
    },
    /// Resume a recorded wecode conversation from a rollout file.
    ResumeConversation {
        params: v1::ResumeConversationParams,
        response: v1::ResumeConversationResponse,
    },
    /// Fork a recorded wecode conversation into a new session.
    ForkConversation {
...
/// This event is internal-only. Used by wecode Cloud.
        ...
        let request = ClientRequest::Initialize {
            ...
            params: v1::InitializeParams {
                client_info: v1::ClientInfo {
                    ...
                    title: Some("wecode VS Code Extension".to_string()),
